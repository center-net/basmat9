        ...
        <section class="home-blog">
            ...
            <div class="container">
                <div class="section-head d-sm-flex align-items-center justify-content-between">
                    ...
                    <div class="head-btn">
                        <a href="<?php echo e(route('blog')); ?>" class="button-round">مشاهدة جميع الانجازات</a>
                    </div>
                </div>
    ...
    <section class="home-callback" id="team" style="background-image: url(<?php echo e(asset('site/assets/images/unbound-img2.jpg')); ?>);">
        <div class="container">
            <div class="row align-items-center justify-content-between">
                ...
                <div class="col-lg-3">
                    <img class="white-logo" src="<?php echo e(asset('site/assets/images/logo.jpg')); ?>" alt="logo">
...
<?php echo $__env->make('site.include.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel\basmat9\resources\views/site/home.blade.php ENDPATH**/ ?>