    ...
    <div class="container-fluid mt--6">
                        ...
                        <table class="table align-items-center table-flush">
                            ...
                            <tbody class="list">
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo e($initiative->active); ?></td>
                                        <td><?php echo e($initiative->image); ?></td>
                                        <td>

                                            <button type="button" class="btn btn-danger btn-sm" data-toggle="modal"
                                                data-target="#exampleModaldelete<?php echo e($initiative->id); ?>" title=" حذف"><i
                                                    class="fa fa-close"></i> حذف</button>


                                            <button type="button" class="btn btn-info btn-sm" data-toggle="modal"
                                                data-target="#exampleModalconvert<?php echo e($initiative->id); ?>" title=" تعديل"><i
                                                    class="fa fa-edit"></i> تعديل</button>

                                        </td>

                                        <div class="modal fade" id="exampleModaldelete<?php echo e($initiative->id); ?>" tabindex="-1"
                                            role="dialog" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-body">
                                                        <form action="<?php echo e(route('admin.initiative_delete', $initiative->id)); ?>"
                                                            method="post">
                                                            <?php echo csrf_field(); ?>
                                        ...
                                        <div class="modal fade" id="exampleModalconvert<?php echo e($initiative->id); ?>"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <form action="<?php echo e(route('admin.initiativeedit', $initiative->id)); ?>"
                                                            method="post">

                                                            <?php echo csrf_field(); ?>
                                                            <div class="form-group">
                                                                <div class="col">
                                                                    <input id="Name" type="text" name="title" class="form-control" value="<?php echo e($initiative->title); ?>">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="col">
                                                                    <input type="text" class="form-control" name="description" value="<?php echo e($initiative->description); ?>">
                                                                </div>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="col">
                                                            ...
                                                            <div class="form-group">
                                                                <textarea class="form-control" name="text_news" id="exampleFormControlTextarea1"
                                                                    rows="3"><?php echo e($initiative->text_news); ?></textarea>
                                                            </div>
                                                            <div class="form-group">
                                                                <div class="col">

                                                                    <?php if( $initiative->status == 'yes' ): ?>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-7">
                            <div class="dataTables_paginate paging_bootstrap_full_number" id="sample_1_paginate">
                                <?php echo e($initiatives->links('pagination::bootstrap-4')); ?>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <!-- add_form -->
                    <form action="<?php echo e(route('admin.addinitiatives')); ?>" method="POST">
                        <?php echo csrf_field(); ?>
                        <div class="form-group">
                            <div class="col">
...
<?php echo $__env->make('dashboard.layout', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\laravel\basmat\resources\views/dashboard/pages/initiatives/index.blade.php ENDPATH**/ ?>